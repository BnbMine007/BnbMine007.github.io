...
function secondsToString(seconds)
{
    ...
    var numdays = Math.floor(seconds / 2592000);

    var numhours = Math.floor((seconds % 2592000) / 3600);

    var numminutes = Math.floor(((seconds % 2592000) % 3600) / 60);

    var numseconds = ((seconds % 2592000) % 3600) % 60;
    var endstr=""
